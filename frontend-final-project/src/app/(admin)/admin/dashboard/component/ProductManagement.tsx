            ...
            <div className="absolute z-20 bg-white shadow rounded-lg w-full h-fit">
              ...
              {(selectedAllBrand ||
                ...
                <div className="flex gap-1 items-center py-2 px-5 overflow-scroll">
                  ...
                  {!selectedAllBrand && (
                    <>
                      {selectedBrandFilter.map((filter) => (
                  ...
                  {!selectedAllType && (
                    <>
                      {selectedTypeFilter.map((filter) => (
                        <div className="border border-emerald-400 shadow px-2 rounded-xl whitespace-nowrap">
                          {filter}
                        </div>
                      ))}
                    </>
                  ...
                  {!selectedAllPrice && (
                    <>
                      {selectedPriceFilter.map((filter) => (
                        <div className="border border-yellow-400 shadow px-2 rounded-xl whitespace-nowrap">
                          {filter}
                        </div>
                      ))}
                    </>
                  ...
                  {!selectedAllTotalSales && (
                    <>
                      {selectedTotalSalesFilter.map((filter) => (
                        <div className="border border-rose-400 shadow px-2 rounded-xl whitespace-nowrap">
                          {filter}
                        </div>
                      ))}
                    </>
