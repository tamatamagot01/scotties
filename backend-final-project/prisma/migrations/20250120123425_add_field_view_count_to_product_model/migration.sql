...
INSERT INTO "new_Product" ("brandId", "description", "id", "imageUrl", "isActive", "price", "productName", "typeId") SELECT "brandId", "description", "id", "imageUrl", "isActive", "price", "productName", "typeId" FROM "Product";
DROP TABLE "Product";
